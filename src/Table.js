...
export const mortgageRepayment = [
    {
		created : "2023-05-28",
		principal : resultLongFormatter(46815845.15),
		interest : resultLongFormatter(585198.06),
		principal_interest : resultLongFormatter(47401043.21),
		balance : resultLongFormatter(45866543.21),
		monthly_replayment : resultLongFormatter(1534500.0),
        monthly_replayment_aus : resultFormatter(3300.0, 'AUD'),
		status: 'paid',
       deltaType: 'increase',
	},
    {
		created : "2023-04-26",
		principal : resultLongFormatter(47846257.38),
		interest : resultLongFormatter(598078.22),
		principal_interest : resultLongFormatter(48444335.6),
		balance : resultLongFormatter(46815845.15),
		monthly_replayment : resultLongFormatter(1628490.45),
        monthly_replayment_aus : resultFormatter(3502.13, 'AUD'),
		status: 'paid',
       deltaType: 'increase',
	},
    {
